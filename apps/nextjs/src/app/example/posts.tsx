  ...
  return (
    <div className='bg-muted flex flex-row p-4 rounded-lg'>
      <div className='flex-grow'>
        <h2 className={cn('bg-primary font-bold rounded text-2xl w-1/4', pulse && 'animate-pulse')}>
          &nbsp;
        </h2>
        <p className={cn('bg-current mt-2 rounded text-sm w-1/3', pulse && 'animate-pulse')}>
          &nbsp;
        </p>
      </div>
    </div>
