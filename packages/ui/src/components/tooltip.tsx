  ...
  TooltipContent = ({
    ...
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        className={cn(
          'animate-in bg-primary data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 fade-in-0 px-3 py-1.5 rounded-md text-balance text-primary-foreground text-xs w-fit z-50 zoom-in-95',
          className
        )}
